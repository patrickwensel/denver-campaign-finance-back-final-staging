...
{
    public class UnpaidObligationsRequestApiModel
    {
        ...
        public UnpaidObligationContactInfo contactInfo { get; set; }
        [JsonIgnore]
        ...
        [JsonIgnore]
        public decimal RefundOrPaidAmount { get; set; } = 0;
        [JsonIgnore]
    ...
    public class UnpaidObligationContactInfo
    {
